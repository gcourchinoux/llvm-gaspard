//===-- GaspardAluCode.h - ALU operator encoding ----------------------------===//
//
...
#ifndef LLVM_LIB_TARGET_Gaspard_GaspardALUCODE_H
#define LLVM_LIB_TARGET_Gaspard_GaspardALUCODE_H
...
const int Gaspard_PRE_OP = 0x40;
const int Gaspard_POST_OP = 0x80;

inline static unsigned encodeGaspardAluCode(unsigned AluOp) {
...
inline static const char *GaspardAluCodeToString(unsigned AluOp) {
...
inline static AluCode stringToGaspardAluCode(StringRef S) {
...
inline static AluCode isdToGaspardAluCode(ISD::NodeType Node_type) {
  switch (Node_type) {
  case ISD::ADD:
    return AluCode::ADD;
  case ISD::ADDE:
...
#endif // LLVM_LIB_TARGET_Gaspard_GaspardALUCODE_H
