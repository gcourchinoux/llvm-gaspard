//= GaspardInstPrinter.h - Convert Gaspard MCInst to asm syntax -------*- C++ -*--//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a Gaspard MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_Gaspard_MCTARGETDESC_GaspardINSTPRINTER_H
#define LLVM_LIB_TARGET_Gaspard_MCTARGETDESC_GaspardINSTPRINTER_H
...
class GaspardInstPrinter : public MCInstPrinter {
public:
  GaspardInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
...
#endif // LLVM_LIB_TARGET_Gaspard_MCTARGETDESC_GaspardINSTPRINTER_H
