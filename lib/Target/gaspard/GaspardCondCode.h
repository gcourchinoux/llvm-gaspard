...
#ifndef LLVM_LIB_TARGET_Gaspard_GaspardCONDCODE_H
#define LLVM_LIB_TARGET_Gaspard_GaspardCONDCODE_H
...
inline static StringRef GaspardCondCodeToString(LPCC::CondCode CC) {
  switch (CC) {
  case LPCC::ICC_T:
    return "t"; // true
  case LPCC::ICC_F:
...
inline static CondCode suffixToGaspardCondCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_Gaspard_GaspardCONDCODE_H
