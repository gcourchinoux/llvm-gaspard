//===- TestDisassembler.cpp - Disassembler for Test ---------------*- C++ -*-===//
//
...
///
/// \file
/// This file is part of the Test Disassembler.
///
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "Test-disassembler"

using DecodeStatus = MCDisassembler::DecodeStatus;

namespace {

/// A disassembler class for Test.
class TestDisassembler : public MCDisassembler {
public:
  std::unique_ptr<MCInstrInfo const> const MCII;

  TestDisassembler(const MCSubtargetInfo &STI, MCContext &Ctx,
...
static const uint16_t GPR32DecoderTable[] = {
    Test::R0,  Test::R1,    Test::R2,  Test::R3,   Test::R4,  Test::R5,  Test::R6,
    Test::R7,  Test::R8,    Test::R9,  Test::R10,  Test::R11, Test::R12, Test::R13,
    Test::R14, Test::R15,   Test::R16, Test::R17,  Test::R18, Test::R19, Test::R20,
    Test::R21, Test::R22,   Test::R23, Test::R24,  Test::R25, Test::GP,  Test::FP,
    Test::SP,  Test::ILINK, Test::R30, Test::BLINK};
...
#include "TestGenDisassemblerTables.inc"
...
DecodeStatus TestDisassembler::getInstruction(MCInst &Instr, uint64_t &Size,
...
static MCDisassembler *createTestDisassembler(const Target &T,
                                             const MCSubtargetInfo &STI,
                                             MCContext &Ctx) {
  return new TestDisassembler(STI, Ctx, T.createMCInstrInfo());
}

extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeTestDisassembler() {
  // Register the disassembler.
  TargetRegistry::RegisterMCDisassembler(getTheTestTarget(),
                                         createTestDisassembler);
}
