...
! %bb.0:
	...
	or	 GPR12, lo(chiara_handle_no_stack_pointer)
	st	 GPR12, 12[ GPR9]
	st	 GPR0, 8[ GPR9]
	ld	0[ GPR3],  GPR9
	uld.b	16[ GPR9],  GPR12
	...
	or	 GPR12, lo(chiara_handle_bad_permissions)
	st	 GPR12, 28[ GPR9]
	st	 GPR0, 24[ GPR9]
	ld	0[ GPR3],  GPR9
	uld.b	32[ GPR9],  GPR12
	...
	or	 GPR12, lo(chiara_handle_bad_opcode)
	st	 GPR12, 44[ GPR9]
	st	 GPR0, 40[ GPR9]
	ld	0[ GPR3],  GPR9
	uld.b	48[ GPR9],  GPR12
	...
	or	 GPR9, lo(chiara_handle_bad_adress)
	st	 GPR9, 60[ GPR3]
	st	 GPR0, 56[ GPR3]
	mov	0x4,  GPR3
	bt	.LBB6_1
